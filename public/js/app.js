...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var urlRegion = '/regions',
    urlCity = '/cities',
    countries = document.getElementById('country'),
    region = document.getElementById('region'),
    city = document.getElementById('city'),
    defaultCountry = _defineProperty({}, countries.name, 1);
  ...
  }).then(statusResponse).then(jsonResponse).then(function (data) {
  ...
  countries.addEventListener('change', function () {
    var dataCountry = _defineProperty({}, countries.name, countries.value);
  ...
  region.addEventListener('change', function () {
    var dataRegion = _defineProperty({}, region.name, +region.value);
    city.options.length = 0;
