...
@section('content')
    ...
    <section class="search-filter">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('show.cards') }}" class="check-form">
                        <h4>Поиск жилья</h4>
...
{{-- <div class="search">
    <form class="search-form" action="">
        <div class="search__block">
            <input class="search__item" type="text" placeholder="например: Сочи">
...
<div class="welcome">
    <form class="form" method="POST" action="" id="search-form">
        @csrf
        <div>
